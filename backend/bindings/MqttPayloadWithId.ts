...
export type MqttPayloadWithId = { id: number, uptime: number, connection: PayloadConnection, location: PayloadLocation, altitude: PayloadAltitude, speed: PayloadSpeed, course: PayloadCourse, datetime: PayloadDateTime, satellites: PayloadSatellites, dop: PayloadDop, stats: PayloadStats, };

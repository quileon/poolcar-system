...
export type MqttPayload = { uptime: number, connection: PayloadConnection, location: PayloadLocation, altitude: PayloadAltitude, speed: PayloadSpeed, course: PayloadCourse, datetime: PayloadDateTime, satellites: PayloadSatellites, hdop: PayloadHdop, stats: PayloadStats, };
